            ...
            const PricingSection = () => {
                return (
                    ...
                    <div className=' py-28 grid grid-cols-1 md:grid-cols-3 gap-8'>
                        <div className='flex flex-col space-y-4  p-8 rounded-xl bg-[#f9fafc]'>
                            ...
                            <button className='bg-blue-500 text-white py-2 px-4 rounded-md w-full mt-6 hover:bg-blue-600'>Get Started Free</button>
                        </div>


                        {/* card 2 */}
                        <div className='relative flex flex-col space-y-4 p-8 rounded-xl bg-gradient-to-b from-[#4F39F6] to-[#9514FA] text-white'>
                            <div className='space-y-3 '>
                            ...
                            <button className='bg-white text-blue-700 py-2 px-4 rounded-md w-full mt-6 hover:bg-gray-100'>Contact Sales</button>
                        ...
                        <div className='flex flex-col space-y-4 p-8 rounded-xl  bg-[#f9fafc]'>
                            ...
                            <button className='bg-blue-500 text-white py-2 px-4 rounded-md w-full mt-6 hover:bg-blue-600'>Contact Sales</button>
                        </div>
