...
const ProductCard = ({ product, carts, setCarts }) => {
    ...
    return (
        <>
            <div className="shadow-lg rounded-xl border-[#f2f2f2FF] px-8 py-4 flex flex-col h-full" key={product.id} >
                <div className="flex flex-col space-y-4 flex-1">
                  ...
                  <div className="flex flex-col space-y-2 items-start ml-8">
