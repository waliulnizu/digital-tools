...
const CartsSection = ({ carts }) => {
    ...
    return (
        ...
        <div className='bg-[#f2f2f2FF] px-16 py-12 rounded-xl mt-12'>
            ...
            {
                carts.map((cart => <div key ={cart.id} className='border border-gray-300 rounded-2xl my-4 p-4'>
        ...
        <button className='btn w-full mt-4 bg-red-600 text-3xl text-white rounded-lge '>Procced to checkout</button>
        </div>
